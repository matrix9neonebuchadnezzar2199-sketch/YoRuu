...
**最終更新**: 2026-05-27  
**現在 PHASE**: PHASE 1 — **M1.3** ch13 執筆（ch12 まで APPROVED 4/6）；HTML モックは PHASE 2  
...
| M1.3 進捗 | **4 / 6** 章完了（ch9〜12） |
| 現在マイルストーン | **M1.3**（ch13 ペーパー約定 執筆） |
...
| 12 | モード仕様（backtest / paper / simmer / live） | [`12_mode_specification.md`](./12_mode_specification.md) | APPROVED | `pending` |
