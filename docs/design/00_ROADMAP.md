...
| M1.2 | ch8 UIモック**設計書のみ** `APPROVED`（HTML は PHASE 2） | 2日 | 待機 |
| M1.3 | ch9〜14 詳細設計（操作フロー・関数+データモデル・戦略・モード・ペーパー約定・i18n） | 3日 | 待機 |
...
| 日付 | バージョン | 変更内容 | コミット |
|------|-----------|----------|----------|
| 2026-05-27 | v1.0 | 初版作成、PHASE 0 完了確認、M1.0 ロードマップ整備 | (本コミット) |
