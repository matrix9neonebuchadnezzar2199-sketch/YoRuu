...
Opus の設計判断は **推奨採用を既定** とし、マスターが明示的に修正指示しない限り推奨内容で確定として進める。確定済み論点は下表および ch10 正本（v1.2+）に反映済み。ドラフト履歴は [`archive/principal-rollout-2026-05-28/`](./archive/principal-rollout-2026-05-28/README.md)。
