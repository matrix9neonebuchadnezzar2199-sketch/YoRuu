...
(function (global) {
  ...
  const COMMANDS = [
    { id: "hub", key: "cmd.goto_hub", href: "/pages/index.html", keys: [] },
    {
      ...
      href: "/pages/01_dashboard.html",
      keys: ["g", "d"],
    },
    {
      id: "trade_log",
      key: "cmd.goto_trade_log",
      href: "/pages/02_trade_log.html",
      keys: ["g", "l"],
    },
    {
      id: "nightly",
    ...
    },
    {
      ...
      href: "/pages/09_markov_live.html",
      keys: ["g", "m"],
    },
    {
      id: "whatif",
      key: "cmd.goto_what_if",
      href: "/pages/10_what_if.html",
      keys: ["g", "w"],
    },
    {
      id: "alerts",
    ...
    },
    {
      ...
      href: "/pages/07_mode_switch.html",
      keys: ["g", "x"],
    },
